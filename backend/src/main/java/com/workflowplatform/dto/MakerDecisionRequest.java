...
public class MakerDecisionRequest {
    ...
    // Constructors
    public MakerDecisionRequest() {}

    public MakerDecisionRequest(String taskId, Long caseId, List<ItemDecision> decisions, String comments) {
        this.taskId = taskId;
        this.caseId = caseId;
    ...
    public static class ItemDecision {
        ...
        public ItemDecision(Long itemId, DecisionItem.DecisionType decision, String comments) {
            this.itemId = itemId;
